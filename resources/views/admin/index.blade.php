                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="overflow: hidden;">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Number Of Sellers
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{Auth::user()->where('sell', 'yes')->count()}}</div>
                                                </div>
                        ...
                        function drawDashboard() {
                            ...
                            var sel = {!! json_encode(Auth::user()->where('sell', 'yes')->count()) !!};
                            var cli = {!! json_encode(Auth::user()->count()) !!};
                        ...
                        <div id="dashboard_div" style="position: relative; left:25%;">
